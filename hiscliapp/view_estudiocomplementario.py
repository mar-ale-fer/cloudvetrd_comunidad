...
from .form_estudiocomplementario import estudio_complementario_InlineFormSet

class admin_estudiocomplementario(UpdateView):
    template_name= 'hiscliapp/form_estudio_complementario.html'
    model = Paciente
    form_class = Paciente_Header_Form
    success_url = reverse_lazy('hiscliapp:paciente_listar')
    
    def get_form_kwargs(self):
        kwargs= super(admin_estudiocomplementario, self).get_form_kwargs()
        kwargs.update({
    ...
    def get(self, request, *args, **kwargs):
        ...
        formset = estudio_complementario_InlineFormSet(instance = self.object,
              queryset = (self.object).estudiocomplementario_set.order_by("fecha_estudio") )
    ...
    def post(self, request, *args, **kwargs):
        ...
        formset = estudio_complementario_InlineFormSet(request.POST, request.FILES, 
